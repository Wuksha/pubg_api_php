            ...
            <div id="main" class="container">
               <div class="row text-white">
                  <?php
                     ...
                     {
                         $d = $date;
                         $days = intval($date / 2592000)." months ago";
                         if($days < 1)
                         {
                             $days = intval($d / 86400)." days ago";
                         }
                         if($days < 1)
                         {
                  ...
                  <div class = "match col-lg-6" data-match-number = "Match <?php echo $i ?>" >
                     <?php
                        ...
                        $noTeams = $match_deatils['GameDetails']['numberOfTeams'];
                        ...
                        ?>
                     <div class = "match-box <?php if($rank<=10 && $rank!=1) echo "topten"; else if($rank==1) echo "gold";?>">
                        <div class = "match-s-info">
                           ...
                           <div class = "middle-section">
                              <div class = "middle-inner-section">
                                 <div class = "match__rank">
                                    <span id = "m-rank" class = "<?php if($rank<=10 && $rank != 1) echo "topten-n"; else if($rank==1) echo "gold-n";?>">
                                    <?php if($rank==1) echo " <div class = 'c-chk-img'><img class = 'chk-image' src = '../resources/chicken_dinner.png'></div>"?>
                                       #<?php echo $rank; ?>
                                    </span>
                                    /<?php echo $noTeams; ?>
                                 </div>
                           ...
                           <div class = "right-section"><p>dsasasasasasasasasasa</p></div>
                        </div>
                     </div>
                  </div>
                  <?php endfor; 
